...
class DepositsControllerTest < ActionController::TestCase
  ...
  test "should create deposit" do
    assert_difference('Deposit.count') do
      post :create, deposit: { balance: @deposit.balance, customer_id: @deposit.customer_id, duration_months: @deposit.duration_months, interest: @deposit.interest }
    end
  ...
  test "should update deposit" do
    patch :update, id: @deposit, deposit: { balance: @deposit.balance, customer_id: @deposit.customer_id, duration_months: @deposit.duration_months, interest: @deposit.interest }
    assert_redirected_to deposit_path(assigns(:deposit))
  end
